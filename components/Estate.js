    ...
    <div className={props.myClass}>
      ...
      >
        ...
        <div className="d-flex justify-content-between px-2 pt-1 dir-r">
          <div>
            <FontAwesomeIcon icon={faMapMarkerAlt} className="text-gery ms-1" />
