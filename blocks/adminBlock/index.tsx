...
export default function AdminBlock({ children }) {
    ...
    <li className="nav-item">
        <Link href="/management/user">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" fill="currentColor" className="feather" viewBox="0 0 24 24">
    ...
    <li className="nav-item">
        <Link href="/management/realestate">
            <a className="nav-link active" aria-current="page" href="#">
            <svg xmlns="http://www.w3.org/2000/svg" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="24" height="24" fill="currentColor" className="feather" viewBox="0 0 24 24">
