...
export default function SearchRent(props) {
  ...
  function pushUrl() {
    ...
    navigate.push(
      `/Rent?pageNumber=1&pageSize=8&cityId=${city}&type=${form.type.value}&cityAreaId=${area}&roomCount=${form.roomCount.value}&meter=${form.surface.value}&assignmentType=${form.assignmentType.value}&price=${form.price.value}`
    );
  }
